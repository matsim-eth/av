...
public class AVVehicleCreator {
	...
	public void createVehicle(AVVehicle vehicle) {
		createVehicle(vehicle, VehicleUtils.getDefaultVehicleType());
	}

	public void createVehicle(AVVehicle vehicle, VehicleType vehicleType) {
		...
		schedule.addTask(
				new AVStayTask(vehicle.getServiceBeginTime(), vehicle.getServiceEndTime(), vehicle.getStartLink()));
